...
void loop() {
  ...
  // Revise according to sensed environment
  if (trigger==true)  // If A0 channel is touched (grounded), phase lights in and out
  {
    period = 1;
    timeshift = 10;
...
//    }
    ...
    */
    ...
    // Sense environment
    // Serial.println(analogRead(0));    //debug
//    if(analogRead(0) < 50)
//    {
//      trigger = true;
//      // Signal that A0 has been touched.
